...
const SectionNav = ({ sections, activeSection }: { sections: { id: string; title: string; icon: React.ReactNode }[]; activeSection: string }) => {
  return (
...
const DeveloperDocs = () => {
  ...
  const sections = [
    ...
    { id: "phone-format", title: "Phone Format", icon: <Phone className="h-4 w-4" /> },
    { id: "sender-id", title: "Sender ID", icon: <Zap className="h-4 w-4" /> },
    { id: "user-endpoints", title: "User Endpoints", icon: <User className="h-4 w-4" /> },
    { id: "sms-endpoints", title: "SMS Endpoints", icon: <MessageSquare className="h-4 w-4" /> },
    { id: "bulk-sms", title: "Bulk SMS", icon: <FileText className="h-4 w-4" /> },
    { id: "errors", title: "Error Responses", icon: <AlertCircle className="h-4 w-4" /> },
    { id: "quick-reference", title: "Quick Reference", icon: <BookOpen className="h-4 w-4" /> },
  ];
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="grid lg:grid-cols-[250px_1fr] gap-12">
            ...
            <div className="space-y-16">
              ...
              <section id="phone-format" className="scroll-mt-24">
                <h2 className="text-2xl font-bold text-foreground mb-6 flex items-center gap-3">
              ...
              {/* Sender ID Section */}
              <section id="sender-id" className="scroll-mt-24">
                <h2 className="text-2xl font-bold text-foreground mb-6 flex items-center gap-3">
              ...
              <section id="user-endpoints" className="scroll-mt-24">
                <h2 className="text-2xl font-bold text-foreground mb-6 flex items-center gap-3">
  ...
  "data": null
              ...
              {/* SMS Endpoints Section */}
              <section id="sms-endpoints" className="scroll-mt-24">
                <h2 className="text-2xl font-bold text-foreground mb-6 flex items-center gap-3">
  ...
  "data": {
    ...
    "sent_messages": [...]
              ...
              {/* Bulk SMS Section */}
              <section id="bulk-sms" className="scroll-mt-24">
                <h2 className="text-2xl font-bold text-foreground mb-6 flex items-center gap-3">
